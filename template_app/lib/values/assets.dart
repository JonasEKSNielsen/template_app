...
enum Asset { whiteBackground, blackBackground, logIn, whiteIcon, blackIcon }
    ...
    switch (asset) {
      case Asset.whiteBackground:
        return const AssetImage(
          'assets/backgrounds/image_background_white.png',
        );
      case Asset.blackBackground:
        return const AssetImage(
          'assets/backgrounds/image_background_black.png',
        );
      case Asset.logIn:
